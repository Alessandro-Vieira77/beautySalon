  ...
  return (
    <div className="w-full max-w-2xl min-h-screen px-5 py-5 mx-auto bg-background">
      ...
      <main className="flex flex-col gap-6.5 w-full mt-6.5">
        ...
        {/* search */}
        <div className="flex items-center w-full h-12 rounded-xl bg-white px-3">
          <button
        ...
        <section className="w-full">
          <div className="flex items-center justify-between w-full">
            ...
            <p className="text-base text-colorSubTitle">All services</p>
          </div>
          <div className="flex justify-between w-full mt-4">
            <div className="flex flex-col justify-center items-center gap-2 w-18.5 h-22 rounded-xl bg-backgroundhair">
              <BsScissors size={22} color="#FFF" />
              <p className="text-white">hair</p>
            </div>
            <div className="flex flex-col justify-center items-center gap-2 w-18.5 h-22 rounded-xl bg-backgroundhair">
              <GiLipstick size={22} color="#FFF" />
              <p className="text-white">Makeup</p>
            </div>
            <div className="flex flex-col justify-center items-center gap-2 w-18.5 h-22 rounded-xl bg-backgroundhair">
            ...
            <div className="flex flex-col justify-center items-center gap-2 w-18.5 h-22 rounded-xl bg-backgroundhair">
              ...
              <p className="text-white">Nails</p>
            </div>
          </div>
        </section>
